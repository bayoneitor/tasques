...
<main>
    ...
    ?>
            <div id="formulario">
                <h1>AÑADIR TAREA</h1>
                <form action="?url=dasaction" method="post">
        ...
        case 'remove':
            ...
            $tarea = "";
            if ($db) {
                $tasks = selectWhereWithJoin($db, 'task', 'users', ['task.id', 'task.description', 'task.due_date'], 'user', 'id', ['task.id', $idTask]);
        ...
        ?>
            <div id="formulario" style="height: 300px;">
                ...
                <div class="flex" style="justify-content:center;align-items:center;"><a href="?url=dasaction&action=delete&id=<?= $idTask ?>" class="btn btn-success">Sí</a> <a href="?url=dashboard" class="btn btn-danger">No</a></div>
            </div>
        ...
        ?>
            <section style="margin: 50px auto;width:85%;">
                <table class="table table-hover table-dark" id="table">
                    <a href="?url=dashboard&action=add" id="add">+</a>
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                    ...
                    <tbody>
                        ...
                        foreach ($tasks as $task) {
                            ...
                            echo '<td>
                                    ...
                                    <a href="?url=dashboard&action=edit&id=' . $idTask . '">
                                    ...
                                    <a href="?url=dashboard&action=remove&id=' . $idTask . '">
